...
const semester6 = [
  {
    id: 1,
    src: 'https://placehold.co/100x100/F97316/FFFFFF?text=GEO+II', // Matches shadow-orange-500
    title: 'Geotechnical Engineering-II',
    style: 'shadow-orange-500',
  },
  {
    id: 2,
    src: 'https://placehold.co/100x100/3B82F6/FFFFFF?text=ENV+II', // Matches shadow-blue-500
    title: 'Environmental Engineering-II',
    style: 'shadow-blue-500',
  },
  {
    id: 3,
    src: 'https://placehold.co/100x100/EAB308/000000?text=STEEL', // Matches shadow-yellow-500
    title: 'Desing of Steel Structure',
    style: 'shadow-yellow-500',
  },
  {
    id: 4,
    src: 'https://placehold.co/100x100/A855F7/FFFFFF?text=MGMT', // Matches shadow-purple-500
    title: 'Construction Engineering And Management',
    style: 'shadow-purple-500',
  },
  {
    id: 5,
    src: 'https://placehold.co/100x100/22C55E/FFFFFF?text=ECON', // Matches shadow-green-500
    title: 'Engineering Economics, Estimation and Costing',
    style: 'shadow-green-500',
  },
  {
    id: 6,
    src: 'https://placehold.co/100x100/EF4444/FFFFFF?text=ELECTIVE+I', // Matches shadow-red-400
...
function SubjectForCivil6() {
  const navigate = useNavigate();

  const handleClick = (title) => {
    const formattedTitle = title.toLowerCase().replace(/\s+/g, '-');
    navigate(`/civil/sem6/${formattedTitle}`);
  };
...
export default SubjectForCivil6;
