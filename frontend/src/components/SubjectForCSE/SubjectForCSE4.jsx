...
const semester4 = [
  {
    id: 1,
    src: 'https://placehold.co/100x100/F97316/FFFFFF?text=COA', // Matches shadow-orange-500
    title: 'Computer Organisation And Architecture',
    style: 'shadow-orange-500',
  },
  {
    id: 2,
    src: 'https://placehold.co/100x100/3B82F6/FFFFFF?text=DIGITAL', // Matches shadow-blue-500
    title: 'Digital Electronics',
    style: 'shadow-blue-500',
  },
  {
    id: 3,
    src: 'https://placehold.co/100x100/EAB308/000000?text=DISCRETE', // Matches shadow-yellow-500
    title: 'Discrete Mathematics',
    style: 'shadow-yellow-500',
  },
  {
    id: 4,
    src: 'https://placehold.co/100x100/A855F7/FFFFFF?text=EVS', // Matches shadow-purple-500
    title: 'Environmental Science',
    style: 'shadow-purple-500',
  },
  {
    id: 5,
    src: 'https://placehold.co/100x100/22C55E/FFFFFF?text=HRD', // Matches shadow-green-500
    title: 'Human Resorces Development',
    style: 'shadow-green-500',
  },
  {
    id: 6,
    src: 'https://placehold.co/100x100/EF4444/FFFFFF?text=OS', // Matches shadow-red-400
    title: 'Operating System',
    style: 'shadow-red-400',
  },
  {
    id: 7,
    src: 'https://placehold.co/100x100/EF4444/FFFFFF?text=DAA', // Matches shadow-red-400
    title: 'Design And Analysis of Algorithm',
    style: 'shadow-red-400',
  },
];

function SubjectForCSE4() {
  const navigate = useNavigate();

  const handleClick = (title) => {
    const formattedTitle = title.toLowerCase().replace(/\s+/g, '-');
    navigate(`/cse/sem4/${formattedTitle}`);
  };
