...
const semester3 = [
  {
    id: 1,
    src: 'https://placehold.co/100x100/F97316/FFFFFF?text=AEC', // Matches shadow-orange-500
    title: 'Analog Electronic Circuit',
    style: 'shadow-orange-500',
  },
  {
    id: 2,
    src: 'https://placehold.co/100x100/3B82F6/FFFFFF?text=DSA', // Matches shadow-blue-500
    title: 'Data Structure And Algorithm',
    style: 'shadow-blue-500',
  },
  {
    id: 3,
    src: 'https://placehold.co/100x100/EAB308/000000?text=MATH+III', // Matches shadow-yellow-500
    title: 'Mathematics-III (Differnetial Calculus)',
    style: 'shadow-yellow-500',
  },
  {
    id: 4,
    src: 'https://placehold.co/100x100/A855F7/FFFFFF?text=OOP+C++', // Matches shadow-purple-500
    title: 'Object Oriented Programming Using C++',
    style: 'shadow-purple-500',
  },
  {
    id: 5,
    src: 'https://placehold.co/100x100/22C55E/FFFFFF?text=TECH+WRITE', // Matches shadow-green-500
...
function SubjectForCSE3() {
  ...
  const handleClick = (title) => {
    ...
    // Corrected navigation path to /cse/sem3/
    navigate(`/cse/sem3/${formattedTitle}`); 
  };
