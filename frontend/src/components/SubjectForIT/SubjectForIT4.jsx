...
const semester4 = [
  {
    id: 1,
    src: 'https://placehold.co/100x100/F97316/FFFFFF?text=COA', // Orange background for Computer Organisation And Architecture
    title: 'Computer Organisation And Architecture',
    style: 'shadow-orange-500',
  },
  {
    id: 2,
    src: 'https://placehold.co/100x100/3B82F6/FFFFFF?text=DBMS', // Blue background for Database Management System
    title: 'Database management System',
    style: 'shadow-blue-500',
  },
  {
    id: 3,
    src: 'https://placehold.co/100x100/EAB308/000000?text=ML', // Yellow background for Machine Learning
    title: 'Machine Learning',
    style: 'shadow-yellow-500',
  },
  {
    id: 4,
    src: 'https://placehold.co/100x100/A855F7/FFFFFF?text=FLAT', // Purple background for Formal Language And Automata Theory
    title: 'Formal Language And Automata Theory',
    style: 'shadow-purple-500',
  },
];

function SubjectForIT4() {
  const navigate = useNavigate();

  const handleClick = (title) => {
    const formattedTitle = title.toLowerCase().replace(/\s+/g, '-');
    navigate(`/it/sem4/${formattedTitle}`);
  };
