...
const semester2 = [
  {
    id: 1,
    src: 'https://placehold.co/100x100/F97316/FFFFFF?text=EME', // Orange background for Elements Of Mechanical Engineering
    title: 'Elements Of Mechanical Engineering',
    style: 'shadow-orange-500',
  },
  {
    id: 2,
    src: 'https://placehold.co/100x100/3B82F6/FFFFFF?text=MATH+2', // Blue background for Engineering Mathematics 2
    title: 'Engineering Mathematics 2',
    style: 'shadow-blue-500',
  },
  {
    id: 3,
    src: 'https://placehold.co/100x100/EAB308/000000?text=PHYSICS', // Yellow background for Engineering Physics
    title: 'Engineering Physics',
    style: 'shadow-yellow-500',
  },
  {
    id: 4,
    src: 'https://placehold.co/100x100/A855F7/FFFFFF?text=PPS', // Purple background for Programming For Problem Solving
    title: 'Programming For Problem Solving',
    style: 'shadow-purple-500',
  },
  {
    id: 5,
    src: 'https://placehold.co/100x100/22C55E/FFFFFF?text=WORKSHOP', // Green background for Workshop
    title: 'Workshop',
    style: 'shadow-green-500',
  },
];

function SubjectForMechanical2() {
  const navigate = useNavigate();

  const handleClick = (title) => {
    const formattedTitle = title.toLowerCase().replace(/\s+/g, '-');
    navigate(`/mechanical/sem2/${formattedTitle}`);
  };
...
export default SubjectForMechanical2;
