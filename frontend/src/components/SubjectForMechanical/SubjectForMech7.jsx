...
const semester7 = [
  {
    id: 1,
    src: 'https://placehold.co/100x100/F97316/FFFFFF?text=ICE', // Orange background for Internal Combustion Engines
    title: 'Internal Combustion Engines',
    style: 'shadow-orange-500',
  },
  {
    id: 2,
    src: 'https://placehold.co/100x100/3B82F6/FFFFFF?text=INDUCT', // Blue background for Induction Program
    title: 'Induction Program',
    style: 'shadow-blue-500',
  },
  {
    id: 3,
    src: 'https://placehold.co/100x100/EAB308/000000?text=OE+II', // Yellow background for Open Elective-II
    title: 'Open Elective-II',
    style: 'shadow-yellow-500',
  },
  {
    id: 4,
    src: 'https://placehold.co/100x100/A855F7/FFFFFF?text=PE+III', // Purple background for Program Elective-III
    title: 'Program Elective-III',
    style: 'shadow-purple-500',
  },
  {
    id: 5,
    src: 'https://placehold.co/100x100/22C55E/FFFFFF?text=PE+IV', // Green background for Program Elective-IV
    title: 'Program Elective-IV',
    style: 'shadow-green-500',
  },
  {
    id: 6,
    src: 'https://placehold.co/100x100/EF4444/FFFFFF?text=PROJECT+I', // Red background for Project-I
    title: 'Project-I',
    style: 'shadow-red-400',
  },
  {
    id: 7,
    src: 'https://placehold.co/100x100/DC2626/FFFFFF?text=ENT+III', // Red background for Summer Entrepreneurship-III
    title: 'Summer Entrepreneurship-III',
    style: 'shadow-red-400',
  },
];

function SubjectForMechanical7() {
  const navigate = useNavigate();

  const handleClick = (title) => {
    const formattedTitle = title.toLowerCase().replace(/\s+/g, '-');
    navigate(`/mechanical/sem7/${formattedTitle}`);
  };
...
export default SubjectForMechanical7;
