...
const semester1 = [
  ...
  {
    id: 2,
    src: 'https://placehold.co/100x100/3B82F6/FFFFFF?text=MATH+I', // Matches shadow-blue-500
    title: 'Engineering Mathematics I',
    style: 'shadow-blue-500',
  },
  {
    id: 3,
    src: 'https://placehold.co/100x100/EAB308/000000?text=PHYSICS', // Matches shadow-yellow-500
    title: 'Engineering Physics',
    style: 'shadow-yellow-500',
  },
  {
    id: 4,
    src: 'https://placehold.co/100x100/A855F7/FFFFFF?text=PPS', // Matches shadow-purple-500
...
function SubjectForElectrical1() {
  const navigate = useNavigate();

  const handleClick = (title) => {
    const formattedTitle = title.toLowerCase().replace(/\s+/g, '-');
    navigate(`/electrical/sem1/${formattedTitle}`);
  };
...
export default SubjectForElectrical1;
