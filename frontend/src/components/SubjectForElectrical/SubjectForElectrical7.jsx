...
const semester7 = [
  {
    id: 1,
    src: 'https://placehold.co/100x100/F97316/FFFFFF?text=PSP', // Matches shadow-orange-500
    title: 'Power System Protection',
    style: 'shadow-orange-500',
  },
  {
    id: 2,
    src: 'https://placehold.co/100x100/3B82F6/FFFFFF?text=VALUES', // Matches shadow-blue-500
    title: 'Human Values And Ethics',
    style: 'shadow-blue-500',
  },
  {
    id: 3,
    src: 'https://placehold.co/100x100/EAB308/000000?text=PE+IV', // Matches shadow-yellow-500
    title: 'Program Elective-IV',
    style: 'shadow-yellow-500',
  },
  {
    id: 4,
    src: 'https://placehold.co/100x100/A855F7/FFFFFF?text=OE+I', // Matches shadow-purple-500
    title: 'Open Elective-I',
    style: 'shadow-purple-500',
  },
  {
    id: 5,
    src: 'https://placehold.co/100x100/22C55E/FFFFFF?text=OE+II', // Matches shadow-green-500
