...
const semester6 = [
  {
    id: 1,
    src: 'https://placehold.co/100x100/F97316/FFFFFF?text=DSP', // Matches shadow-orange-500
    title: 'Digital Signal Processing',
    style: 'shadow-orange-500',
  },
  {
    id: 2,
    src: 'https://placehold.co/100x100/3B82F6/FFFFFF?text=VLSI', // Matches shadow-blue-500
    title: 'Introduction To VLSI Design',
    style: 'shadow-blue-500',
  },
  {
    id: 3,
    src: 'https://placehold.co/100x100/EAB308/000000?text=PS+II', // Matches shadow-yellow-500
    title: 'Power System-II',
    style: 'shadow-yellow-500',
  },
  {
    id: 4,
    src: 'https://placehold.co/100x100/A855F7/FFFFFF?text=PE+II', // Matches shadow-purple-500
  ...
  {
    id: 6,
    src: 'https://placehold.co/100x100/EF4444/FFFFFF?text=PSD', // Matches shadow-red-400
    title: 'Professional Skill Development',
    style: 'shadow-red-400',
  },
  {
    id: 7,
    src: 'https://placehold.co/100x100/EF4444/FFFFFF?text=MOOCS+II', // Matches shadow-red-400
    title: 'MOOCS-II',
    style: 'shadow-red-400',
  },
];

function SubjectForElectrical6() {
  const navigate = useNavigate();

  const handleClick = (title) => {
    const formattedTitle = title.toLowerCase().replace(/\s+/g, '-');
    navigate(`/electrical/sem6/${formattedTitle}`);
  };
...
export default SubjectForElectrical6;
