...
const semester3 = [
  {
    id: 1,
    src: 'https://placehold.co/100x100/F97316/FFFFFF?text=ANALOG+ELEC', // Matches shadow-orange-500
    title: 'Analog Electronics',
    style: 'shadow-orange-500',
  },
  {
    id: 2,
    src: 'https://placehold.co/100x100/3B82F6/FFFFFF?text=ECA', // Matches shadow-blue-500
    title: 'Electical Circuit Analysis',
    style: 'shadow-blue-500',
  },
  {
    id: 3,
    src: 'https://placehold.co/100x100/EAB308/000000?text=ELEC+MACH+I', // Matches shadow-yellow-500
    title: 'Electrical Machines-I',
    style: 'shadow-yellow-500',
  },
  {
    id: 4,
    src: 'https://placehold.co/100x100/A855F7/FFFFFF?text=EM+FIELDS', // Matches shadow-purple-500
    title: 'Electromagnetic Fields',
    style: 'shadow-purple-500',
  },
  {
    id: 5,
    src: 'https://placehold.co/100x100/22C55E/FFFFFF?text=ENG+MECH', // Matches shadow-green-500
