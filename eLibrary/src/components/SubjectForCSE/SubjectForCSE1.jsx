...
const semester1 = [
  {
    id: 1,
    src: 'https://placehold.co/100x100/F97316/FFFFFF?text=PPS', // Matches shadow-orange-500
    title: 'Programming For Problem Solving',
    style: 'shadow-orange-500',
  },
  {
    id: 2,
    src: 'https://placehold.co/100x100/3B82F6/FFFFFF?text=BEE', // Matches shadow-blue-500
    title: 'Basic Electronics Engineering',
    style: 'shadow-blue-500',
  },
  {
    id: 3,
    src: 'https://placehold.co/100x100/EAB308/000000?text=MATH+I', // Matches shadow-yellow-500
    title: 'Engineering Mathematics I',
    style: 'shadow-yellow-500',
  },
  {
    id: 4,
    src: 'https://placehold.co/100x100/A855F7/FFFFFF?text=PHYSICS', // Matches shadow-purple-500
    title: 'Engineering Physics',
    style: 'shadow-purple-500',
  },
  {
    id: 5,
    src: 'https://placehold.co/100x100/22C55E/FFFFFF?text=WORKSHOP', // Matches shadow-green-500
    title: 'Workshop',
    style: 'shadow-green-500',
  },
];

function SubjectForCSE1() {
  const navigate = useNavigate();

  const handleClick = (title) => {
    const formattedTitle = title.toLowerCase().replace(/\s+/g, '-');
    navigate(`/cse/sem1/${formattedTitle}`);
  };
