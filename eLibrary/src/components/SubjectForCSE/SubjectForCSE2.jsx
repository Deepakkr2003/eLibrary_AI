...
const semester2 = [
  {
    id: 1,
    src: 'https://placehold.co/100x100/F97316/FFFFFF?text=ENGLISH', // Matches shadow-orange-500
    title: 'Communicative English',
    style: 'shadow-orange-500',
  },
  {
    id: 2,
    src: 'https://placehold.co/100x100/3B82F6/FFFFFF?text=CHEMISTRY', // Matches shadow-blue-500
    title: 'Engineering Chemistry',
    style: 'shadow-blue-500',
  },
  {
    id: 3,
    src: 'https://placehold.co/100x100/EAB308/000000?text=MATH+2', // Matches shadow-yellow-500
    title: 'Engineering Mathematics 2',
    style: 'shadow-yellow-500',
  },
  {
    id: 4,
    src: 'https://placehold.co/100x100/A855F7/FFFFFF?text=WEB+DEV', // Matches shadow-purple-500
    title: 'Introduction To Web Design',
    style: 'shadow-purple-500',
  },
  {
    id: 5,
    src: 'https://placehold.co/100x100/22C55E/FFFFFF?text=PYTHON', // Matches shadow-green-500
