...
const semester4 = [
  {
    id: 1,
    src: 'https://placehold.co/100x100/F97316/FFFFFF?text=GEOLOGY', 
    title: 'Engineering Geology',
    style: 'shadow-orange-500',
  },
  {
    id: 2,
    src: 'https://placehold.co/100x100/3B82F6/FFFFFF?text=FLUID', 
    title: 'Introduction To Fluid Mechanics',
    style: 'shadow-blue-500',
  },
  {
    id: 3,
    src: 'https://placehold.co/100x100/EAB308/000000?text=SOLID', 
  ...
  {
    id: 5,
    src: 'https://placehold.co/100x100/22C55E/FFFFFF?text=STRUCT', 
    title: 'Structure Analysis',
    style: 'shadow-green-500',
  },
  {
    id: 6,
    src: 'https://placehold.co/100x100/EF4444/FFFFFF?text=MAT+TEST', 
    title: 'Materials, Testing And Evaluation',
    style: 'shadow-red-400',
  },
  {
    id: 7,
    src: 'https://placehold.co/100x100/EF4444/FFFFFF?text=DISASTER', 
    title: 'Disaster Preparadness And Planning',
    style: 'shadow-red-400',
  },
  {
    id: 8,
    src: 'https://placehold.co/100x100/EF4444/FFFFFF?text=CA+LAB', 
