...
const semester7 = [
  {
    id: 1,
    src: 'https://placehold.co/100x100/F97316/FFFFFF?text=PROF.LAW', // Matches shadow-orange-500
    title: 'Professional Practice, Law Of Ethics',
    style: 'shadow-orange-500',
  },
  {
    id: 2,
    src: 'https://placehold.co/100x100/3B82F6/FFFFFF?text=EMPLOY', // Matches shadow-blue-500
    title: 'Graduate Employability Skills',
    style: 'shadow-blue-500',
  },
  {
    id: 3,
    src: 'https://placehold.co/100x100/EAB308/000000?text=ELECTIVE+II', // Matches shadow-yellow-500
    title: 'Program Elective-II',
    style: 'shadow-yellow-500',
  },
  {
    id: 4,
    src: 'https://placehold.co/100x100/A855F7/FFFFFF?text=ELECTIVE+III', // Matches shadow-purple-500
    title: 'Program Elective-III',
    style: 'shadow-purple-500',
  },
  {
    id: 5,
    src: 'https://placehold.co/100x100/22C55E/FFFFFF?text=PROJECT+I', // Matches shadow-green-500
    title: 'Project-I',
    style: 'shadow-green-500',
  },
  {
    id: 6,
    src: 'https://placehold.co/100x100/EF4444/FFFFFF?text=SUMMER+II', // Matches shadow-red-400
...
function SubjectForCivil7() {
  const navigate = useNavigate();

  const handleClick = (title) => {
    const formattedTitle = title.toLowerCase().replace(/\s+/g, '-');
    navigate(`/civil/sem7/${formattedTitle}`);
  };
...
export default SubjectForCivil7;
