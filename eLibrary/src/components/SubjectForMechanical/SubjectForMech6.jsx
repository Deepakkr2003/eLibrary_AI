...
const semester6 = [
  {
    id: 1,
    src: 'https://placehold.co/100x100/F97316/FFFFFF?text=AUTO+MFG', // Orange background for Automation In Manufacturing
    title: 'Automation In Manufacturing',
    style: 'shadow-orange-500',
  },
  {
    id: 2,
    src: 'https://placehold.co/100x100/3B82F6/FFFFFF?text=DME', // Blue background for Design of Machine Elements
    title: 'Design of Machine Elements',
    style: 'shadow-blue-500',
  },
  {
    id: 3,
    src: 'https://placehold.co/100x100/EAB308/000000?text=DOM', // Yellow background for Dynamics of Machinery
    title: 'Dynamics of Machinery',
    style: 'shadow-yellow-500',
  },
  {
    id: 4,
    src: 'https://placehold.co/100x100/A855F7/FFFFFF?text=MFG+TECH', // Purple background for Manufacturing Technology
    title: 'Manufacturing Technology',
    style: 'shadow-purple-500',
  },
  {
    id: 5,
    src: 'https://placehold.co/100x100/22C55E/FFFFFF?text=OE+I', // Green background for Open Elective-I
    title: 'Open Elective-I',
    style: 'shadow-green-500',
  },
  {
    id: 6,
    src: 'https://placehold.co/100x100/EF4444/FFFFFF?text=PE+I', // Red background for Program Elective-I
    title: 'Program Elective-I',
    style: 'shadow-red-400',
  },
  {
    id: 7,
    src: 'https://placehold.co/100x100/DC2626/FFFFFF?text=PE+II', // Red background for Program Elective-II
