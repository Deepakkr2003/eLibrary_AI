...
const semester1 = [
  ...
  {
    id: 3,
    src: 'https://placehold.co/100x100/EAB308/000000?text=GRAPHICS', // Yellow background for Engineering Graphics And Design
    title: 'Engineering Graphics And Design',
    style: 'shadow-yellow-500',
  },
  {
    id: 4,
    src: 'https://placehold.co/100x100/A855F7/FFFFFF?text=MATH+I', // Purple background for Engineering Mathematics I
...
function SubjectForMechanical1() {
  const navigate = useNavigate();

  const handleClick = (title) => {
    const formattedTitle = title.toLowerCase().replace(/\s+/g, '-');
    navigate(`/mechanical/sem1/${formattedTitle}`);
  };
...
export default SubjectForMechanical1;
