...
const semester3 = [
  {
    id: 1,
    src: 'https://placehold.co/100x100/F97316/FFFFFF?text=BEE', // Orange background for Basic Electronics Engineering
    title: 'Basic Electronics Engineering',
    style: 'shadow-orange-500',
  },
  {
    id: 2,
    src: 'https://placehold.co/100x100/3B82F6/FFFFFF?text=ENG+MECH', // Blue background for Engineering Mechanics
    title: 'Engineering Mechanics',
    style: 'shadow-blue-500',
  },
  {
    id: 3,
    src: 'https://placehold.co/100x100/EAB308/000000?text=MACH+DRAW', // Yellow background for Machine Drawing (assuming 'Machie Drawing' was a typo)
    title: 'Machie Drawing', // Note: Typo 'Machie' maintained from user input
    style: 'shadow-yellow-500',
  },
  {
    id: 4,
    src: 'https://placehold.co/100x100/A855F7/FFFFFF?text=MATH+III', // Purple background for Mathematics-III
    title: 'Mathematics-III',
    style: 'shadow-purple-500',
  },
  {
    id: 5,
    src: 'https://placehold.co/100x100/22C55E/FFFFFF?text=THERMO', // Green background for Thermodynamics
    title: 'Thermodynamics',
    style: 'shadow-green-500',
  },
];

function SubjectForMechanical3() {
  const navigate = useNavigate();

  const handleClick = (title) => {
    const formattedTitle = title.toLowerCase().replace(/\s+/g, '-');
    navigate(`/mechanical/sem3/${formattedTitle}`);
  };
...
export default SubjectForMechanical3;
