...
const semester2 = [
  {
    id: 1,
    src: 'https://placehold.co/100x100/F97316/FFFFFF?text=B.E.', // Matches shadow-orange-500
...
function SubjectForECE2() {
  const navigate = useNavigate();
  
  const handleClick = (title) => {
    const formattedTitle = title.toLowerCase().replace(/\s+/g, '-');
    navigate(`/ece/sem2/${formattedTitle}`);
  };
