...
const semester7 = [
  {
    id: 1,
    src: 'https://placehold.co/100x100/F97316/FFFFFF?text=BUS+ANALYTICS', // Matches shadow-orange-500
    title: 'Business Analytics',
    style: 'shadow-orange-500',
  },
  {
    id: 2,
    src: 'https://placehold.co/100x100/3B82F6/FFFFFF?text=WIRELESS+COMM', // Matches shadow-blue-500
    title: 'Wireless Communication',
    style: 'shadow-blue-500',
  },
  {
    id: 3,
    src: 'https://placehold.co/100x100/EAB308/000000?text=PE+II', // Matches shadow-yellow-500
    title: 'Program Elective-II',
    style: 'shadow-yellow-500',
  },
  {
    id: 4,
    src: 'https://placehold.co/100x100/A855F7/FFFFFF?text=PE+III', // Matches shadow-purple-500
