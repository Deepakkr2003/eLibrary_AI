...
const semester6 = [
  {
    ...
    title: 'Biology For Engineer',
    style: 'shadow-orange-500',
  },
  {
    id: 2,
    src: 'https://placehold.co/100x100/3B82F6/FFFFFF?text=DIGITAL+COMM', // Matches shadow-blue-500
    title: 'Digital Communication',
    style: 'shadow-blue-500',
  },
  {
    id: 3,
    src: 'https://placehold.co/100x100/EAB308/000000?text=EIM', // Matches shadow-yellow-500
    title: 'Electronics Instruments And Measurements',
    style: 'shadow-yellow-500',
  },
  {
    id: 4,
    src: 'https://placehold.co/100x100/A855F7/FFFFFF?text=COA', // Matches shadow-purple-500
...
function SubjectForECE6() {
  const navigate = useNavigate();

  const handleClick = (title) => {
    const formattedTitle = title.toLowerCase().replace(/\s+/g, '-');
    navigate(`/ece/sem6/${formattedTitle}`);
  };
