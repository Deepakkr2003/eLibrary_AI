...
const semester8 = [
  ...
  {
    id: 3,
    src: 'https://placehold.co/100x100/EAB308/000000?text=PE+IV', // Yellow background for Program Elective-IV
    title: 'Program Elective-IV',
    style: 'shadow-yellow-500',
  },
  {
    id: 4,
    src: 'https://placehold.co/100x100/A855F7/FFFFFF?text=PE+V', // Purple background for Program Elective-V
...
function SubjectForIT8() {
  const navigate = useNavigate();

  const handleClick = (title) => {
    const formattedTitle = title.toLowerCase().replace(/\s+/g, '-');
    navigate(`/it/sem8/${formattedTitle}`);
  };
