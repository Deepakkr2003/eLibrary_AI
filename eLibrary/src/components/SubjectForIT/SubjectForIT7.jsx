...
const semester7 = [
  {
    id: 1,
    src: 'https://placehold.co/100x100/F97316/FFFFFF?text=BIO+ENG', // Orange background for Biology For Engineering
    title: 'Biology For Engineering',
    style: 'shadow-orange-500',
  },
  {
    id: 2,
    src: 'https://placehold.co/100x100/3B82F6/FFFFFF?text=OE+I', // Blue background for Open Elective-I
  ...
  {
    id: 5,
    src: 'https://placehold.co/100x100/22C55E/FFFFFF?text=INDUCT', // Green background for Induction Program
