...
const semester1 = [
  ...
  {
    id: 2,
    src: 'https://placehold.co/100x100/3B82F6/FFFFFF?text=MATH+I', // Blue background for Engineering Mathematics I
...
function SubjectForIT1() {
  const navigate = useNavigate();

  const handleClick = (title) => {
    const formattedTitle = title.toLowerCase().replace(/\s+/g, '-');
    navigate(`/it/sem1/${formattedTitle}`);
  };
